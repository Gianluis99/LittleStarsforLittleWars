...
public class Livelli {
	...
	public static Livello livelloTre() {
		...
		arco5.setNodo1(nodo4);
		arco5.setNod2(nodo6);
		Arco arco10=new Arco(7,5);
		arco10.setNodo1(nodo7);
		arco10.setNod2(nodo5);
		Arco arco11=new Arco(7,6);
		arco11.setNodo1(nodo7);
		arco11.setNod2(nodo6);
		Arco arco12=new Arco(8,3);
		arco12.setNodo1(nodo8);
		arco12.setNod2(nodo3);
		Arco arco13=new Arco(8,4);
		arco13.setNodo1(nodo8);
		...
		Possesso possesso= new Possesso(0,1,-1);
		Possesso possesso9= new Possesso(8,2,-1);
